...
const News = () => {
  ...
  return (
    <div>
      <section id="sec-1" style={sectionStyle('red')}>Section 1</section>
      <section id="sec-2" style={sectionStyle('blue')}>Section 2</section>
      <section id="sec-3" style={sectionStyle('green')}>Section 3</section>
      <section id="sec-4" style={sectionStyle('purple')}>Section 4</section>
      <section id="sec-5" style={sectionStyle('orange')}>Section 5</section>
    </div>
  );
};
